"""
This file contains the configuration for the SQL and Redis connections.
"""
...
class SQLConnection:
    ...
    def get_instance(user, password, host, database, port):
        ...
        if SQLConnection._instance is None:
            ...
            SQLConnection._instance.autocommit = True
            SQLConnection._instance.start_transaction(isolation_level='READ COMMITTED')
